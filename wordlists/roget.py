...
# Original source: https://github.com/evanmiltenburg/roget
...
def index(file,root):
    return re.sub(r'\D','',file) + ' ' + headword(root)
...
for file in glob.glob("roget/head*.txt"):
    with open(file,'rb') as f:
        ...
        roget[index(file,root)] = pos_words(root.getchildren())
